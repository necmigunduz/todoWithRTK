...
const TopNav = () => {
  ...
  return (
    <div className="mx-auto py-5 bg-slate-500 flex justify-between">
      <Link to="/todos-list">
        <div className="ml-2 pl-3 py-1 pr-1 text-amber-600 font-bold tracking-[0.5em] text-lg border-8 border-slate-600 bg-slate-800 rounded-3xl">
          todos
        </div>
      </Link>
      <Link to="/create-todo">
        <Button btnName={"Create a new todo"} />
      </Link>
